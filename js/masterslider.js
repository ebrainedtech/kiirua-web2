 ...
 * Copyright ©   github.com/ebrainedtech2015 All Rights Reserved. 
 *
...
;(function($){
	...
	window.MasterSlider = function(){
		...
		this.options = {
			...
			grKIIRUAursor			: true,		  // Whether the slider uses grab mouse cursor.
...
//
	...
	p._init = function(){
		...
		// add grab cursor
		if(this.options.swipe && !window._touch && this.options.grKIIRUAursor && this.options.mouse){
